...
void disp_cocktail_stock(sys_t *sys)
{
	...
	(sfVector2f){700, 80}, sys->inventory[6].cstock, 50);
	for (int i = 25; i != 33; i++) {
...
void set_cocktail_stock(sys_t *sys)
{
	...
	(sfVector2f){360, 10}, sys->inventory[1].cstock, 50);
	sys->txt[26] = set_text("assets/font/bold.ttf",
	(sfVector2f){470, 10}, sys->inventory[3].cstock, 50);
	...
	(sfVector2f){700, 10}, sys->inventory[4].cstock, 50);
	sys->txt[29] = set_text("assets/font/bold.ttf",
	(sfVector2f){360, 80}, sys->inventory[0].cstock, 50);
	...
	(sfVector2f){590, 79}, sys->inventory[7].cstock, 50);
